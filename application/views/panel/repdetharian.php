                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title"> <span class="label label-success">Laporan Detail Harian</span>
                                        <!--<?php
                                            if($stat == 'new'){
                                ...
                                <form role="form" action="<?php echo site_url('panel/artikel/save');?>" enctype="multipart/form-data" method="POST">
                                    <div class="box-body">
                                     ...
                                     <div class="form-group">
                                            ...
                                            <select name="repdepdetharian" id="repdepdetharian" onchange="javascript:getreptransaksidet();"  class="form-control">
                                            <option value="">-</option>
                                            <?php 
                                         ...
                                         <div class="form-group">
                                            <label for="exampleInputEmail1">Nama</label>
                                             <select name="repdetharpeg" id="repdetharpeg"  class="form-control">
                                            <option value="">-</option>
                                    ...
                                    <div class="box-footer">
                                        <button type="button" class="btn btn-primary" id="prosesreportdetharian">
                                           Proses
                                        </button>
                                    </div>
                                </form>
