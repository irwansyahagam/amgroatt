                                ...
                                <form role="form" action="" enctype="multipart/form-data" method="POST">
                                    <div class="box-body">
                                     ...
                                     <div class="form-group">
                                            ...
                                            <option value="">--Pilih Mode Komunikasi--</option>
                                                <option value="1">Jaringan</option>
                                                <option value="0">USB</option>
                                            </select>
                                        </div>
                                         <div class="form-group">
                                            <label for="ipadd">IP Address
                                            <span style="font-size: 10px;">(Ex : xxx.xxx.xxx.xxx)</span></label>
                                            <input type="text" required="" class="form-control" id="ipadd" name="ip" 
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input type="text" required="" class="form-control" name="nomesin" id="nomesin"
                                    ...
                                    <div class="box-footer">
                                        <button type="button" id="buttonsimpanmesin" class="btn btn-primary">
                                           Simpan
                                        </button>
                                    </div>
                                </form>
