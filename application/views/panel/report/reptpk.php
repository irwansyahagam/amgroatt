...
ob_start();?>
    ...
    <page backtop="3mm" backbottom="3mm" backleft="3mm" backright="3mm">
        <table cellspacing="0" style="width: 100%; font-size: 10px" align="right">
        <tr>
            <td style="width: 100%;text-align: left;padding-left: 960px;">
                <span style="font-size: 10px"><b>
                    Daftar: Tambahan Penghasilan PNS berdasarkan Prestasi Kerja (TPK)
                </b><br/>
                    <b>&nbsp;Bulan <?php echo $bln.' Tahun '.$thn; ?></b>
                </span><br>
            </td>
       ...
       <?php echo $html;?>
        ...
        <table cellspacing="0"  style="width: 100%; font-size: 10px;align:right;">
        <tr>
            <td style="width: 100%;text-align: left;padding-left: 990px;">
...
<?php
    ...
    try
    {
        $html2pdf = new HTML2PDF('l', 'legal', 'fr',true, 'UTF-8', 3);
